...
class AssistantMethods
{
  static Future<String> searchCoordinateAddress(Position position, context) async
  {
    ...
    if(response != 'failed')
    {
      ...
      Address userPickUpAddress = new Address(placeFormattedAddress: '', placeName: '', placeId: '', latitude: null, longitude: null,);
  ...
  static Future<DirectionDetails?> obtainPlaceDirectionDetails(LatLng initialPosition, LatLng finalPosition) async
  {
    ...
    DirectionDetails directionDetails = DirectionDetails(encodedPoints: '', distanceText: '', distanceValue: null, durationText: '', durationValue: null);
